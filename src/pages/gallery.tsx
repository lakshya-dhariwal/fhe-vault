        ...
        <div className="flex-grow h-0 overflow-y-scroll">
          <div className="container mx-auto ">
            ...
            <a
              ...
              data-lightbox="homePortfolio"
            >
              <iframe src="https://www.youtube.com/embed/W0iCWFwwIaQ"></iframe>
            </a>
...
const FileUploadModal = ({ fileUpload, setFileUpload }: any) => {
...
const FileUpload = ({ handleChange }: { handleChange: (e: any) => void }) => {
  return (
